...
const ClientsRow = ({ client, onUpdate }) => {
  ...
  return (
    <>
    <section className='flex flex-wrap w-full bg-blue-900 shadow-md rounded-md mt-4 mb-1 p-4 justify-between'>
    <div className=''>
      <div className='mx-1 p-1 text-base sm:text-2xl font-serif'>
      <span className='me-1 font-semibold text-pink-700'>
        {isEditing ? (
          <input
      ...
      <div className='p-1 m-1 text-orange-200 sm:font-semibold font-serif'>
        {isEditing ? (
          <input
          className='border border-spacing-0 w-32 sm:w-40'
            type="text"
